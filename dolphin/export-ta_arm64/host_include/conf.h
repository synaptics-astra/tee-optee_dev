#ifndef _out_arm_synaptics_dolphin_release_include_generated_conf_h_
#define _out_arm_synaptics_dolphin_release_include_generated_conf_h_
...
#define PLATFORM_FLAVOR dolphin
#define PLATFORM_FLAVOR_dolphin 1
