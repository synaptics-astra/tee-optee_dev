#ifndef _out_arm_synaptics_myna2_release_include_generated_conf_h_
#define _out_arm_synaptics_myna2_release_include_generated_conf_h_
...
#define PLATFORM_FLAVOR myna2
#define PLATFORM_FLAVOR_myna2 1
